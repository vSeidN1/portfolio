...
<template>
  <div
    class="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 transition-colors duration-300"
  >
    <header
      class="sticky top-0 z-45 w-full border-b border-slate-200/40 dark:border-slate-850/45 glass-panel"
    >
      <div
    ...
    <footer
      class="border-t border-slate-200/50 dark:border-slate-900 bg-white/30 dark:bg-slate-950/30 backdrop-blur-sm py-12 safe-pb"
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div class="md:col-span-2 space-y-4">
            ...
            <p
              class="text-sm text-slate-500 dark:text-slate-400 max-w-sm leading-relaxed"
            >
          ...
          <div>
            <h4
              class="text-sm font-bold uppercase tracking-wider text-slate-800 dark:text-slate-100 mb-4 font-display"
            >
              Navigation
            </h4>
            <ul class="space-y-2">
        ...
        <div
          class="border-t border-slate-200/50 dark:border-slate-850 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-550 dark:text-slate-400"
        >
          <p>
            © {{ new Date().getFullYear() }}
            {{ portfolioData.personalInfo.name }}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
